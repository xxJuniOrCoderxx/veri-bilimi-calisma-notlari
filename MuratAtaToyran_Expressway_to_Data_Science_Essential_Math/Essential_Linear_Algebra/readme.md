...
3. adım: Seçtiğimiz satırdaki tüm değerler için <mark> $$(-1)^{i+j} \cdot det(A_{ij}) \cdot A_{ij}$$ </mark> değerini hesaplayıp bu değerleri topladığımızda 3x3 matrisiçin determinantı elde etmiş oluruz.
