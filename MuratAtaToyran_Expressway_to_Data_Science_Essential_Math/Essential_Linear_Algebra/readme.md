...
3. adım: Seçtiğimiz satırdaki tüm değerler için <mark style="background-color: #0d51c3"> $$(-1)^{i+j} \cdot det(A_{ij}) \cdot X_{ij}$$ </mark> değerini hesaplayıp bu değerleri topladığımızda 3x3 matrisiçin determinantı elde etmiş oluruz.
