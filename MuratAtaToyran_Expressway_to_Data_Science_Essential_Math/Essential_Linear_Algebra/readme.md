...
3. adım: Seçtiğimiz satırdaki tüm değerler için <span style="background-color: #FFFF00"> $$(-1)^{i+j} \cdot det(A_{ij}) \cdot X_{ij}$$ </span> değerini hesaplayıp bu değerleri topladığımızda 3x3 matrisiçin determinantı elde etmiş oluruz.
